...
TEST_CASES = [
    {
        ...
        'category': 'onboarding',
        'type': 'sequence',
        'messages': ['cmd_onboard', 'Hi', 'My name is Abdul', "I'm in Pittsburgh, PA", 'What can you do for me?'],
        'sequence_delay': 8,
        'wait': 60,
        'pass_criteria': 'Asmi acknowledges the name and location. Final response describes capabilities.',
