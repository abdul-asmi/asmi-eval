...
TEST_CASES = [
    ...
    },
    {
        ...
        'followups': [
            'Use a top-rated Thai restaurant in Los Angeles.',
            'If you still need a specific place, pick the nearest highly rated option.',
        ],
        'auto_continue': True,
        'max_turns': 3,
    ...
    },
    {
        ...
        'followups': [
            ...
            'Use the nearest major pharmacy chain.',
        ],
        'auto_continue': True,
        'max_turns': 3,
    ...
    },
    {
        ...
        'followups': [
            'Saturday at 7pm for 2 people.',
            'Italian would be great if they have it.',
        ],
        'auto_continue': True,
        'max_turns': 4,
    ...
    },
    {
        ...
        'followups': [
            'Use a dentist in Austin, Texas.',
            'I need something after work hours if possible.',
        ],
        'auto_continue': True,
        'max_turns': 3,
