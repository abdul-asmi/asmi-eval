TEST_CASES = [
    {
        'id': 'core_01v1',
        'name': 'Core: Pre-onboarding first call YES',
        'category': 'core test',
        'type': 'sequence',
        ...
        'sequence_delay': 5,
        'source_test_id': 'preonb_01v1',
    },
    {
        'id': 'core_02v1',
        'name': 'Core: Simple task immediate call YES',
        'category': 'core test',
        'type': 'sequence',
        'messages': ['Need to plan a birthday party', 'Sure'],
        'pass_criteria': 'Only pass if Asmi asks for a call',
        'source_test_id': 'adh_01v1',
    },
    {
        'id': 'core_03v1',
        'name': 'Core: Third-party call lookup',
        'category': 'core test',
        'type': 'sequence',
        'messages': ['Call nearest chinese restaurant and book a table for 2 for 6PM'],
    ...
    },
    {
        ...
        'category': 'adhoc call',
        'type': 'sequence',
        'messages': ['I need to sort out a few things — renew my car insurance, book a dentist appointment, and find a good electrician nearby.'],
    ...
    },
    {
        ...
        'category': 'adhoc call',
        'type': 'sequence',
        'messages': ['Can you call someone and check on my prescription refill at the pharmacy?'],
    ...
    },
    {
        ...
        'category': 'adhoc call',
        'type': 'sequence',
        'messages': ['Can you help me cancel my gym membership?'],
    ...
    },
    {
        ...
        'category': 'adhoc call',
        'type': 'sequence',
        'messages': ['Please call my landlord about the noise complaint I filed last week.'],
    ...
    },
    {
        ...
        'category': 'adhoc call',
        'type': 'sequence',
        'messages': ['Can you call my landlord at (412) 555-0166 about the broken heater?', 'Actually forget that — call the plumber at (412) 555-0177 instead.'],
    ...
    },
    {
        ...
        'category': '3P Calls',
        'type': 'sequence',
        'messages': ["Call Joe's Pizza and ask about their catering options."],
    ...
    },
    {
        ...
        'category': '3P Calls',
        'type': 'sequence',
        'messages': ['Call (412) 555-0123 and ask if they have a table for 2 tonight at 7pm.', 'call anyway'],
    ...
    },
    {
        ...
        'category': '3P Calls',
        'type': 'sequence',
        'messages': ['Call (412) 555-0199 right now.', "don't bother"],
    ...
    },
    {
        ...
        'category': '3P Calls',
        'type': 'sequence',
        'messages': ['Call (412) 555-0000 and ask about their hours.'],
    ...
    },
    {
        ...
        'category': 'PDF',
        'type': 'sequence',
        'messages': ['Make me a plan PDF from what we just discussed.'],
    ...
    },
    {
        ...
        'category': 'PDF',
        'type': 'sequence',
        'messages': ['Can you send me a PDF summary of my tasks?'],
    ...
    },
    {
        ...
        'category': 'PDF',
        'type': 'sequence',
        'messages': ['Find me flights from Pittsburgh to NYC next Friday under $200.', 'Also add oat milk and greek yogurt to my grocery list.', "Now give me a PDF of everything we've worked on with their status."],
    ...
    {
        'id': 'call_01v1',
        'name': 'Gym cancellation end-to-end',
        'category': 'call_eval',
        'type': 'call_eval',
        'messages': ['Cancel my Workup Gym membership, call {{call_number}}'],
        'persona_prompt': 'You are a Workup Gym customer service rep. You can process cancellations after verifying: member name and reason for leaving. Be slightly reluctant but ultimately cooperative.',
        'pass_criteria': 'Asmi successfully initiates cancellation in the call. Rep acknowledges it. Asmi sends a chat follow-up confirming outcome.',
        'wait': 30,
        'sequence_delay': 8,
    },
    {
        'id': 'call_02v1',
        'name': 'Dentist appointment booking',
        'category': 'call_eval',
        'type': 'call_eval',
        'messages': ['Can you call {{call_number}} and book a dentist appointment for me next Tuesday afternoon?'],
        'persona_prompt': 'You are a receptionist at Sparkle Dental. You have openings next Tuesday at 2:00 PM and 4:30 PM. You require the patient name and date of birth to book.',
        'pass_criteria': 'Asmi schedules the appointment successfully for next Tuesday afternoon, providing patient details. Asmi confirms the final time and details in chat.',
        'wait': 30,
        'sequence_delay': 8,
    },
    {
        'id': 'call_03v1',
        'name': 'Pharmacy prescription check',
        'category': 'call_eval',
        'type': 'call_eval',
        'messages': ['Call {{call_number}} to see if my prescription is ready for pickup.'],
        'persona_prompt': 'You are a pharmacist at CVS. When asked for prescription status, ask for patient name and Rx number (let them know Rx number is on the bottle). If they give name as Gaffoor and say they do not have Rx number, look it up and say: Yes, it is ready for pickup.',
        'pass_criteria': 'Asmi successfully calls the pharmacist, provides the patient name Gaffoor, handles the inquiry when asked for the Rx number, and confirms in chat that the prescription is ready for pickup.',
        'wait': 30,
        'sequence_delay': 8,
    },
]
